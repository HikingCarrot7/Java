...
public class PruebaDatos 
{
	...
	public static void main(String[] args) 
	{
		...
		do 
		{
			...
			System.out.println("\nPresione 1.- Cambiar nombre o 2.- Añadir saldo ");
			opcion = in.nextInt();
			...
			case 1:
				...
				indice = JOptionPane.showInputDialog("¿A quién le quieres cambiar el nombre?");
				opcion = Integer.parseInt(indice);
				//System.out.println("¿A quién le quieres cambiar el nombre?");
				//opcion = in.nextInt();
			...
			case 2:
				...
				System.out.println("¿A quién le quieres añadir saldo? ");
				opcion = in.nextInt();
