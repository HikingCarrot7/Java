...
public class BotonAcciones 
{
	...
	private static Object[] objetos = {"Nicolás", new ImageIcon("src/practicadialogos/lifes.png"), new JPanel() 
	{
	...
	private static Object[][] cadenaseimagenes = {{"Nicolás", "Carlos", "Iván"}, {new ImageIcon("src/practicadialogos/lifes.png"), new ImageIcon("src/practicadialogos/lifes.png"), new ImageIcon("src/practicadialogos/lifes.png"),}};
	...
	public static void AccionesBoton() 
	{
		...
		{		
			if(Lamina.secciones[0].toString().contentEquals("Mensaje")) 
				JOptionPane.showMessageDialog(null, obtenerMensaje(), "Título", obtenerTipo(1), null);
			
			else if(Lamina.secciones[0].toString().contentEquals("Confirmar")) 
				JOptionPane.showConfirmDialog(null, obtenerMensaje(), "Título",  obtenerTipo(3), obtenerTipo(1), null);
			
			else if(Lamina.secciones[0].toString().contentEquals("Opción")) 
				JOptionPane.showOptionDialog(null, obtenerMensaje(), "Título",  obtenerTipo(3), obtenerTipo(1), null, obtenerObjetos(4), null);
			
			else 
				JOptionPane.showInputDialog(null, obtenerMensaje(), "Título",  obtenerTipo(1), null, obtenerObjetos(5), null);
		});
	}
