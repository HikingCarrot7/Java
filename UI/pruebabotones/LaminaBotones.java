...
public class LaminaBotones extends JPanel
{
	...
	private JButton[] botones = {new JButton(new AccionBotones("Azul", 0, Color.blue)), new JButton(new AccionBotones("Amarillo", 1, Color.yellow)), new JButton(new AccionBotones("Verde", 2, Color.green))};
	...
	private class AccionBotones extends AbstractAction
	{
		...
		public AccionBotones(String titulo, int i, Color color)
		{
			...
			putValue(Action.SHORT_DESCRIPTION, "Pondrá el fondo de color " + titulo);
