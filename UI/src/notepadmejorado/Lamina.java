...
public class Lamina extends JPanel
{
	...
	private JMenuItem[] estilo = {new JCheckBoxMenuItem("Bold"), new JCheckBoxMenuItem("Italic"), new JCheckBoxMenuItem("Underline")};
	...
	private JMenuItem[] herramientasColor = {anadirColores(Color.yellow, "src/notepadmejorado/yellow.png"), anadirColores(Color.green, "src/notepadmejorado/green.png"), anadirColores(Color.pink, "src/notepadmejorado/pink.png"), anadirColores(Color.black, "src/notepadmejorado/black.png")};
	
	private JMenuItem[] alineacion = {anadirAlineacion(0, "src/notepadmejorado/left.png"), anadirAlineacion(2, "src/notepadmejorado/right.png"), anadirAlineacion(1, "src/notepadmejorado/center.png")};
	...
	public Lamina() 
	{
		...
		JMenuItem[][] items = {fuente, estilo, size, herramientasColor, alineacion}; 
