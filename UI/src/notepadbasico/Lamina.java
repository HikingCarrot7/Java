...
public class Lamina extends JPanel
{
    ...
    {
        new JMenu("Fuente"), new JMenu("Estilo"), new JMenu("Tama�o"), new JMenu("Color fondo"), new JMenu("Color de texto")
    };
    ...
    {
        new JMenuItem(new Accion("Negritas", Font.BOLD)), new JMenuItem(new Accion("Cursivas", Font.ITALIC)), new JMenuItem(new Accion("Normal", Font.PLAIN))
    };

    private JMenuItem[] tamano =
    {
        new JMenuItem(new Accion("10")), new JMenuItem(new Accion("12")), new JMenuItem(new Accion("16")), new JMenuItem(new Accion("24")), new JMenuItem(new Accion("36"))
    };

    private JMenuItem[] colorfondo =
    {
        new JMenuItem(new Accion("Verde", Color.green.brighter())), new JMenuItem(new Accion("Rosado", Color.pink)), new JMenuItem(new Accion("Amarillo", Color.yellow.brighter())), new JMenuItem(new Accion("Blanco", Color.white))
    };
