...
public class Lamina extends JPanel 
{
	...
	public Lamina()
	{
		...
		//Crear un vínculo entre la combinación de teclas y una llave (nombre) 
		...
		//Crear un vínculo entre la combinación de teclas y la accion (poner de colores el fondo)
