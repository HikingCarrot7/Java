...
public class Lamina extends JPanel
{
	...
	private JMenu[] menu = {new JMenu("Archivo"), new JMenu("Edicion"), new JMenu("Herramientas")};
	
	private JMenuItem[][] opciones = {{new JMenuItem("Guardar"), new JMenuItem("Guardar como...")}, {new JMenuItem("Editar")}, {new JMenuItem("Copiar"), new JMenuItem("Pegar"), new JMenuItem("Cortar")}};
	...
	public void anadirMenu() 
	{
		...
		opcion.add(new JMenuItem("Opción 1"));
		opcion.add(new JMenuItem("Opción 2"));
