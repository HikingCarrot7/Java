...
public class Examen
{
    ...
    public static void main(String[] args)
    {
        ...
        Examen.info(new Saludar()
        {
            ...
            public void info()
            {
                System.out.println("Estoy mandando una clase an�nima que implementa una interface como par�metro");
        ...
        new Examen().Resp(new JavaIsCool()
        {
            ...
            public String Resp()
            {
                return "Java no es tan dif�cil, bueno s�, lo es xd";
            }
        ...
        Despedida desp = new Despedida()
        {
            ...
            public void despedirme()
            {
                System.out.println("Bueno, adi�s!");
...
class Recomendacion
{
    ...
    public void R()
    {
        System.out.println("S�gueme en Instagram xd");
    }
    ...
    public class Recom extends Recomendacion
    {
        ...
        public void R()
        {
            System.out.println("S�gueme en Facebook tambi�n xd");
        }
    }
}
