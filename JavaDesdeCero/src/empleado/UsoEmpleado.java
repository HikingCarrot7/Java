...
public class UsoEmpleado 
{
	...
	public static void main(String[] args) {
		...
		misEmpleados[1] = new Programadores("Nicolás Canul", "Programador");
		misEmpleados[2] = new Administrador("Angel Hernández", "Administrador", 5000, 23, 2019, 05, 25);
		misEmpleados[3] = new Administrador("Iván Ojeda", "Administrador");
