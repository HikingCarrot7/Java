	...
	private class DatosAlumno extends JPanel
	{
		...
		private class AccionBoton extends AbstractAction
		{
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				datosCorrectos = confirmar();
				
				datosCorrectos = tamano();
				...
				if(datosCorrectos) 
				{
					...
					LaminaMaestro.maestrosInstanciados.add(new Maestro(nombre.getText(), Integer.parseInt(edad.getText()), asignatura.getText(), Double.parseDouble(salario.getText()), user.getText(), Generales.pasarAString(password.getPassword())));
		...
		{
			pass1.setBackground(Generales.pasarAString(password.getPassword()).contentEquals(Generales.pasarAString(password2.getPassword())) ? Color.green : Color.white);
			pass2.setBackground(Generales.pasarAString(password.getPassword()).contentEquals(Generales.pasarAString(password2.getPassword())) ? Color.green : Color.white);
		}
