...
public class Map 
{
	...
	public void readFile(File mapFile) 
	{
		...
		try 
		{
			...
			while(in.hasNext()) 
			{
				...
				if(!line.startsWith("//")) 
				{
					...
					if(splitString.length >= 3) 
					{
						...
						//se está buscando el bloque que este más cerca y el que está más alejado
						...
						if(mappedTile.y > maxY) maxY = mappedTile.y;
			...
			//Se añaden todos los bloques a sus correspondientes chunks
