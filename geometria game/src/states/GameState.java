...
public class GameState {
	...
	public void divideMeteor(Meteor meteor) {//dividir los meteoros
		...
		switch(size) {//saber que tamaño tiene el meteoro y saber de este modo en que textura se dividira
		case BIG:
			newSize = Size.MED;
			break;
		case MED:
	...
	public void update()
	{
		...
		for(int i = 0; i < explosions.size(); i++) {//animación de explosión
