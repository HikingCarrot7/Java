...
public class Player extends MovingObject {
	...
	
	{
		...
		if(!spawnTime.isRunning()) {//verificamos la posicion del cronometro del jugador, de esta manera sabemos si esta en estado visible o reapareciendo
			spawning = false;
			visible = true;
		}
		...
		if(spawning) {
			...
			if(!flickerTime.isRunning()) {//efecto de parpadeo
	...
	@Override
	public void Destroy() {//cuando el jugador es destruido
		spawning = true;
	...
	@Override
	public void draw(Graphics g) {//efecto de propulsion
