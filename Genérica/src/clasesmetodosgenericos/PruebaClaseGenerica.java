...
//		numeros = new ClaseGenerica<Integer, String>();
		...
		System.out.println(ClaseGenerica.numElementos(new String[] {"Nicol�s", "Estrella"}));
		
		System.out.println(ClaseGenerica.numElementos(new Integer[] {12, 45, 56}));
		
		System.out.println(ClaseGenerica.numElementos(new Personas[] {new Personas(23), new Personas(78), new Personas(45)}));
		
		System.out.println(ClaseGenerica.numElementos(new GregorianCalendar[] {new GregorianCalendar(2015, 11, 11), new GregorianCalendar(2014, 9, 10), new GregorianCalendar(2014, 10, 11)}).getTime());
