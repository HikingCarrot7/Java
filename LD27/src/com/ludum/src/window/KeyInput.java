...
public class KeyInput extends KeyAdapter
{
	...
	public void keyPressed(KeyEvent e)
	{
		...
		{
			if(key == KeyEvent.VK_W){  menu.setSelected(menu.getSelected() - 1); int x = r.nextInt(2);  }
			if(key == KeyEvent.VK_S){ menu.setSelected(menu.getSelected() + 1);int x = r.nextInt(2);  }
			
			if(key == KeyEvent.VK_UP)
			{ 
				menu.setSelected(menu.getSelected() - 1); int x = r.nextInt(2); 
			}
