...
public class MatrizAleatoria 
{
	...
	public static void main(String[] args) 
	{
		...
		for (int i = 0; i < 5; i++) 
		{
			System.out.printf("Inserte sus números de la suerte ");
		...
		if (diagonal == 5) 
		{
			System.out.printf("Insertó la diagonal principal, ganó $5");
			
		} else if (filas == 5)
		{
			System.out.printf("Insertó una fila, ganó $5");
			
		} else if (columnas == 5) 
		{
			System.out.printf("Insertó una columna, ganó $5");
