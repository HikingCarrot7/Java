...
public class KeyInput extends KeyAdapter
{
	...
	public void keyPressed(KeyEvent e) 
	{
		...
		if(key.equals(KeyEvent.VK_UP)) 
			if(!wizard.getKeys().contains(KeyEvent.VK_UP)) wizard.addKey(KeyEvent.VK_UP);

		if(key.equals(KeyEvent.VK_DOWN)) 
			if(!wizard.getKeys().contains(KeyEvent.VK_DOWN)) wizard.addKey(KeyEvent.VK_DOWN);

		if(key.equals(KeyEvent.VK_LEFT)) 
			if(!wizard.getKeys().contains(KeyEvent.VK_LEFT)) wizard.addKey(KeyEvent.VK_LEFT);

		if(key.equals(KeyEvent.VK_RIGHT)) 
			if(!wizard.getKeys().contains(KeyEvent.VK_RIGHT)) wizard.addKey(KeyEvent.VK_RIGHT);	

		if(key.equals(KeyEvent.VK_ESCAPE)) System.exit(1);
