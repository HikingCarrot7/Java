...
public class KeyInput extends KeyAdapter
{
	...
	public void keyPressed(KeyEvent e) 
	{
		...
		if(key.equals(38)) 
			if(!player.getKeys().contains(38)) player.addKey(38);

		if(key.equals(40)) 
			if(!player.getKeys().contains(40)) player.addKey(40);

		if(key.equals(37)) 
			if(!player.getKeys().contains(37)) player.addKey(37);

		if(key.equals(39)) 
			if(!player.getKeys().contains(39)) player.addKey(39);	
